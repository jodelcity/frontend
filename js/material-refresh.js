(function() {
    ...
    (function($){
        ...
        var NUM_POS_MAX_Y = 85;   // Max position for the moving distance
        ...
        function mRefresh(options) {
            ...
            if (!isDefaultType()) {
                ...
                if($(refreshNav).offset()){
                    ...
                    $refreshMain.css('bottom', customNavTop + 'px');
                }
            ...
            if(options.top){
                $refreshMain.css('bottom', options.top);
            }
        ...
        mRefresh.refresh = function(opt) {
            ...
            if(!isShowLoading){
                ...
                $refreshMain.css('bottom', realTargetPos + 'px');
                // make it small
        ...
        function touchStart(e){
            if(isIOS && scrollEl == document.body){
                ...
                touchPos.height = document.documentElement.scrollHeight
                                - document.documentElement.clientHeight;
            }else if(scrollEl != document){
                touchPos.top = document.querySelector(scrollEl).scrollTop;
                touchPos.height = document.querySelector(scrollEl).scrollHeight
                                - document.querySelector(scrollEl).clientHeight;
            } else {
                touchPos.top = window.scrollY || window.pageYOffset || document.body.scrollTop || document.documentElement.scrollTop;
                touchPos.height = (document.documentElement || document.body.parentNode || document.body).scrollHeight
                                - (document.documentElement || document.body.parentNode || document.body).clientHeight;
            }

            if (touchPos.top < touchPos.height || isShowLoading) {
                return;
            }
        ...
        function touchMove(e){
            ...
            if (touchPos.top < touchPos.height || isShowLoading || !e.touches || e.touches.length !== 1) {
        ...
        function backToStart() {
            ...
            if ( isDefaultType() ) {
                $refreshMain.css('bottom', realStartPos + 'px');
        ...
        function moveCircle(y){
            ...
            // Change the position
            $refreshMain.css('bottom', currMoveY + 'px');
